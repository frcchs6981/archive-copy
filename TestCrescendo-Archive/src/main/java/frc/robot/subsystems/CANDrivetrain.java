...
public class CANDrivetrain extends SubsystemBase {
 ...
 MotorController leftFront = new WPI_VictorSPX(2);
 MotorController leftRear = new WPI_VictorSPX(3);
 MotorController rightFront = new WPI_VictorSPX(0);
 MotorController rightRear = new WPI_VictorSPX(1);
  ...
  public void arcadeDrive(double speed, double rotation) {
    ...
    System.out.println("ggsdrewegfgneg");
  }
